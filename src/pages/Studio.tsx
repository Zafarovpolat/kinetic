      ...
      <section className="relative h-screen flex items-center justify-center px-6 md:px-20 z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 w-full max-w-screen-2xl items-center">
          <div className="md:col-span-1 hidden md:block">
            <div className="writing-vertical-rl rotate-180 font-alt text-[10px] uppercase tracking-[1em] opacity-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-20">
              ...
              <Reveal delay={0.4} className="flex flex-col justify-end items-end">
                <div className="text-right">
                  <p className="font-alt text-[10px] uppercase tracking-widest mb-4 opacity-30">Our Mission</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-40">
            <div className="space-y-20">
              <Reveal>
                <div className="space-y-6">
                  <span className="font-alt text-[10px] uppercase tracking-widest opacity-30">01 / Philosophy</span>
              ...
              <Reveal delay={0.2}>
                <div className="space-y-6">
                  <span className="font-alt text-[10px] uppercase tracking-widest opacity-30">02 / Materiality</span>
            ...
            <div className="relative aspect-[3/4] overflow-hidden rounded-3xl group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-10 flex flex-col justify-end">
                <p className="font-alt text-[10px] uppercase tracking-widest mb-2">Location 01</p>
            ...
            <div className="lg:col-span-7">
              <Reveal y={50}>
                <div className="space-y-4">
                  <p className="font-alt text-[10px] uppercase tracking-[0.5em] opacity-30">Connect with the system</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-20">
                <Reveal delay={0.2}>
                  <a href="#" className="group block space-y-4 border-l border-white/10 pl-8 py-4 hover:border-white transition-all duration-500">
                    <p className="font-alt text-[10px] uppercase tracking-widest opacity-30 group-hover:opacity-100 transition-opacity">Digital Presence</p>
                ...
                <Reveal delay={0.3}>
                  <a href="#" className="group block space-y-4 border-l border-white/10 pl-8 py-4 hover:border-white transition-all duration-500">
                    <p className="font-alt text-[10px] uppercase tracking-widest opacity-30 group-hover:opacity-100 transition-opacity">Direct Channel</p>
                  ...
                  <div className="bg-zinc-950 rounded-[1.9rem] p-10 md:p-16 space-y-12">
                    <div className="flex justify-between items-start">
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-alt text-[10px] uppercase tracking-widest opacity-50">System Online</span>
                        </div>
                    ...
                    <div className="space-y-8">
                      <div className="space-y-2">
                        <p className="font-alt text-[10px] uppercase tracking-widest opacity-30">Coordinates</p>
                        <p className="text-xl font-mono">52.5200° N, 13.4050° E</p>
                      </div>
                      <div className="space-y-2">
                        <p className="font-alt text-[10px] uppercase tracking-widest opacity-30">Physical Access</p>
                    ...
                    <div className="pt-12 border-t border-white/5 flex justify-between items-end">
                      <div className="space-y-2">
                        <p className="font-alt text-[10px] uppercase tracking-widest opacity-30">Current Time</p>
                        <p className="text-4xl font-display tracking-tighter">16:44 <span className="text-sm font-alt opacity-30">CET</span></p>
                      </div>
